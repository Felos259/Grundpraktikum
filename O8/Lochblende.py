...
RF = pd.read_csv('O8/Lochblende.csv', header=0, sep=';')

# Durchmesser mit Mikroskop
d = 20 * u.ufloat(4.98, 0.02) * 10**-3
print('Durchmesser Mikroskop: d='+ str(d) + "cm")
...
plt.grid()
plt.savefig("O8/LochblendeOrdnungen.pdf", format='pdf', bbox_inches='tight', pad_inches=0.5) 
plt.show()
