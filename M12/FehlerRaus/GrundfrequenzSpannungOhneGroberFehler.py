...
RF = pd.read_csv('M12/FehlerRaus/GrundfrequenzSpannungOhneGroberFehler.csv', header=3)
...
plt.savefig("M12/FehlerRaus/FrequenzSpannungOhneGroberFehler.pdf", format='pdf', bbox_inches='tight', pad_inches=0.1) 
...
mu2 = pd.read_csv('M12/FehlerRaus/Resonmu.csv', header=0, sep=';')
...
with open('M12/FehlerRaus/mu.csv', 'w', newline='') as csvfile:
