...
plt.savefig("M12/FrequenzSpannung.pdf", format='pdf', bbox_inches='tight', pad_inches=0.5) 
plt.savefig("M12/FrequenzSpannung.svg", format='svg', bbox_inches='tight', pad_inches=0.5) 
