...
label = {'E12/Teil A/3kV.csv' : ['$U_A=3$kV', 'Fit zu $U_A=3$kV', 'red', 'coral'],
         'E12/Teil A/4kV.csv' : ['$U_A=4$kV', 'Fit zu $U_A=4$kV', 'blue', 'lightblue'],
         'E12/Teil A/5kV.csv' : ['$U_A=5$kV', 'Fit zu $U_A=5$kV', 'green', 'limegreen']}
...
for column_name, column in label.items():
    ...
    for j in range(0, len(RF['dI']) , 1):
        ...
        RF.loc[j, 'I'] = RF['I'][j] / 1000
        RF.loc[j, 'dI'] = RF['dI'][j] / 1000
        RF.loc[j, 'e'] = RF['e'][j] / 1000
